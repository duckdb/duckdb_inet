...
struct INetFunctions {
  static bool CastVarcharToINET(Vector &source, Vector &result, idx_t count,
                                CastParameters &parameters);
  static bool CastINETToVarchar(Vector &source, Vector &result, idx_t count,
                                CastParameters &parameters);
  ...
  static void Broadcast(DataChunk &args, ExpressionState &state,
                        Vector &result);
  ...
  static void ContainsLeft(DataChunk &args, ExpressionState &state,
                           Vector &result);
